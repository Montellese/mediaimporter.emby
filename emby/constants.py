...
URL_QUERY_TAG = 'tag'
URL_PROTOCOL_VERIFY_PEER = 'verifypeer'
...
WS_OPTIONS_SSL_CERTIFICATE_REQUEST = 'cert_reqs'
...
SETTING_PROVIDER_USE_HTTPS = 'emby.usehttps'
SETTING_PROVIDER_VERIFY_HTTPS = 'emby.verifyhttps'
